...
add wave -group Reader  -radix hex      /byte_inc_tb/rd_if/readdata
add wave -group Reader                  /byte_inc_tb/rd_if/readdatavalid
...
add wave -group Writer  -radix hex      /byte_inc_tb/wr_if/writedata
